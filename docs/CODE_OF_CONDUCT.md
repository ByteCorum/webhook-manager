...
For other matters, please use the appropriate channel: security vulnerabilities are handled per , and usage questions per .
...
This Code of Conduct applies within all community spaces - the repository (issues, pull requests, code review, Discussions), and any project chat or social channels - and also applies when an individual is officially representing the community in public or other spaces. Examples of representing our community include using an official email address, posting via an official social media account, or acting as an appointed representative at an online or offline event.
